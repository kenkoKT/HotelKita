...
<body>
	...
	<form action="/admin/fhotel/update/{id}{{ $h->id_fhotel }}" method="post">
		...
		<div class="form-group">
		  ...
		  <input type="text" class="form-control" name="nama_fasilitas" required="required" value="{{ $h->nama_fasilitas }}">
		</div>
		<br/>
		<div class="form-group">
		  <label>Keterangan</label>
		  <input type="text" class="form-control" name="keterangan" required="required" value="{{ $h->keterangan }}">
        </div>
        <div class="form-group">
            <label>Image</label>
