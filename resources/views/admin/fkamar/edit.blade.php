...
<body>
	...
	<form action="/admin/kamar/update/{id}{{ $k->id_kamar }}" method="post">
		...
		<div class="form-group">
		  ...
		  <input type="text" class="form-control" name="tipe_kamar" required="required" value="{{ $k->tipe_kamar }}">
		</div>
		<br/>
		<div class="form-group">
		  <label>Jumlah Kamar</label>
		  <input type="number" class="form-control" name="jumlah_kamar" required="required" value="{{ $k->jumlah_kamar }}">
		</div>
		<br/>
